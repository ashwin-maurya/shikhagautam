...
export default function ContactFormInput() {
  return (
    <>
      <section className="bg-blue-400 py-20 max-sm:px-6 2xl:py-32 max-sm:py-16">
        <div className="flex justify-evenly items-center max-sm:flex-col gap-5">
          <form
            id="form"
            className="w-[50%] max-sm:w-[90%] flex flex-col gap-5  font-montserrat"
          >
            <h1 className="text-4xl 2xl:text-5xl  text-white font-sans max-lg:text-center">
              Send a message:
            </h1>
